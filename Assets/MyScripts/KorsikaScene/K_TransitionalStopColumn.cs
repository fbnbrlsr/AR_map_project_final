...
public class K_TransitionalStopColumn : K_IStopColumnVisualization
{   
    ...
    public K_TransitionalStopColumn(float lat, float lon, int nof_stops, GameObject columnPrefab, AbstractMap map, GameObject informationPanelPrefab, Transform mapRoot)
    {
    ...
    public void Print()
    {
        Debug.Log("TransitionalStop: lat=" + lat + ", lon=" + lon + ", nof_stops=" + nof_stops);
    }
