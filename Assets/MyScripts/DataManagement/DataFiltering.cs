...
public class DataFiltering : MonoBehaviour
{

    /*
    *   Manages the filter buttons on the DataFilterPanel.
    *   Enables and disables filters based on buttons being pressed and
    *   passes the result to the DatabaseManager.
    */
    ...
    {   
        ...
        databaseManager.ApplyPathsFilter(
                travelModes, 
                departureTimes,
                arrivalTimes,
                travelDurations
