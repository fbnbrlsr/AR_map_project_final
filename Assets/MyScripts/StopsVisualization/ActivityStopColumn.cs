...
public class ActivityStopColumn : IStopColumnVisualization
{

    /*
    *   This class manages the visualization of a single activity stops column
    ...
    */
    ...
    public ActivityStopColumn(float lat, float lon, int nof_stops, GameObject columnPrefab, GameObject informationPanelPrefab)
    {
